...
class order(models.Model):
    ...
    order_date = models.DateField(default=timezone.now) #auto_now=False, auto_now_add=False
    ...
    def getPaymentType(self):
        return self.payment_type.label in {
    ...
    def __str__(self):
        return str(self.pk)+": "+self.order_date+", "+self.payment_type+". "+str(self.total_amount)+"."
